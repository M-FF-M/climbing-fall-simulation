 ...
 * @param {ClimbingFallSetup} settingsObject an object in which the data from the inputs will be stored
 */
 ...
 * @param {number} stepNumber the number of the step in the setup mask for which the values should be read
 * @param {ClimbingFallSetup} settingsObject the object from which the relevant properties (relevant for the given step) will be removed
 */
 ...
 * @param {ClimbingFallSetup} defaultObject the desired default values
 */
 ...
 * @param {ClimbingFallSetup} settingsObject an object in which the data from the steps which were already completed is stored
 * @param {ClimbingFallSetup} [defaultObject] an object containing the default values (useful if the user pre-loaded a configuration)
 * @return {ClimbingFallSetup} a copy of settingsObject, filled with the properties from the remaining steps
 */
